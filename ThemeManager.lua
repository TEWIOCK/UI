...
local ThemeManager = {} do
	ThemeManager.Folder = 'POOHHUB'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['POOH HUB']         = { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"30333b","AccentColor":"ff0c6","BackgroundColor":"1a1c20","OutlineColor":"ff0bf"}') },
